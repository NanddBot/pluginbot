let handler = async (m, { conn, participants, groupMetadata, text }) => {
    ...
    try {
        ...
        let { isBanned, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink, antiVirtex, expired, descUpdate, stiker } = global.db.data.chats[m.chat]
...
*Total Member :* ${participants.length} Anggota
