...
info = `Hai Kak ${orng} Nih Apk PicsArt Plus Mod v19.4.0 Tanpa WaterMark

Link Download Nya Di Bawah Kak :

♧ Dengan Password : 
https://www.mediafire.com/file/dvdojb1t3bvndfy/PicsartPlus_v19.4.0-GOLD_ModdingUnited.zip/file

♧ Tanpa Password : 
https://cararegistrasi.com/SHpFr67GKi
...
handler.help = ['apkpicsartplus']
handler.tags = ['apkmods']
handler.command = /^apk(picsartplus|paplus)$/i
