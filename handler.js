    ...
    try {
      ...
      m.limit = false
        ...
        if (user) {
            ...
            if (!isNumber(user.glimit)) user.glimit = 40
...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    rowner: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ ʙᴇʙʙ]',
    owner: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴏᴡɴᴇʀ ʙᴇʙʙ]',
    mods: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴇʙʙ]',
    premium: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴘʀᴇᴍɪᴜᴍ ʙᴇʙʙ]',
    group: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴅᴀʟᴀᴍ ɢʀᴜʙ ʙᴇʙʙ]',
    private: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴄʜᴀᴛ ᴘʀɪʙᴀᴅɪ ʙᴇʙʙ]',
    admin: '[ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ᴋʜᴜꜱᴜꜱ ᴀᴅᴍɪɴ ɢʀᴜʙ ʙᴇʙʙ]',
    botAdmin: '[ʙᴏᴛ ʜᴀʀᴜꜱ ᴊᴀᴅɪ ᴀᴅᴍɪɴ ɢʀᴜʙ ᴜɴᴛᴜᴋ ᴘᴇʀɪɴᴛᴀʜ ɪɴɪ ʙᴇʙʙ\n\n𝐈𝐧𝐠𝐚𝐭 𝐘𝐚𝐚 𝐃𝐞𝐤𝐤 𝐅𝐢𝐭𝐮𝐫 𝐓𝐢𝐝𝐚𝐤 𝐀𝐤𝐚𝐧 𝐁𝐞𝐫𝐟𝐮𝐧𝐠𝐬𝐢 𝐊𝐚𝐥𝐚𝐮 𝐁𝐨𝐭 𝐓𝐢𝐝𝐚𝐤 𝐉𝐚𝐝𝐢 𝐀𝐝𝐦𝐢𝐧𝐧]',    
nsfw: '[ɴꜱꜰᴡ ᴏꜰꜰ, ʜᴀɴʏᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ ʏᴀɴɢ ʙɪꜱᴀ ᴍᴇɴɢᴀᴋᴛɪꜰᴋᴀɴ ʙᴇʙʙ]',
    unreg: `Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar NanddBot.16*`
  }[type]
